...
static const char *fonts[]	    = { "Hack:size=10", "Mononoki Nerd Font Mono:style:medium:size=16" }; // fonts
...
static const char col_gray3[]       = "#c8ced4";
static const char col_gray4[]       = "#101010";
static const char col_gray5[]	    = "#1e1f21";
static const char col_cyan[]        = "#604c67";
